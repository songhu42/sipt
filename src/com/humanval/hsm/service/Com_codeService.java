...
import com.humanval.hsm.dao.Com_code;
import com.humanval.hsm.dao.Word_mst;
import com.humanval.hsm.service.Com_codeService;
import com.humanval.hsm.util.NaverCloudAPI;
...
public class Com_codeService {
	...
	/**
	 * Sound Url 이 미설정된 WORD_MST 리스트를 가져와서 Naver Cloud API에서 mp3파일로 저장한다. 
	 * @param whereOption
	 * @return
	 */
