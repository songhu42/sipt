...
public class User_mst {
	...
	private int tot_game_cnt;
	private int cur_game_cnt;
	...
	public int getTot_game_cnt() {
		return tot_game_cnt;
	}
	public void setTot_game_cnt(int tot_game_cnt) {
		this.tot_game_cnt = tot_game_cnt;
	}
	public int getCur_game_cnt() {
		return cur_game_cnt;
	}
	public void setCur_game_cnt(int cur_game_cnt) {
		this.cur_game_cnt = cur_game_cnt;
	}
